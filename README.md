...
```sh
pip install git+https://github.com/thanhan910/ptvopenapi-py.git
```
(you may need to run `pip` with root permission: `sudo pip install git+https://github.com/thanhan910/ptvopenapi-py.git`)
