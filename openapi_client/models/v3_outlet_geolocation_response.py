...
class V3OutletGeolocationResponse(BaseModel):
    ...
    """ # noqa: E501
    outlets: Optional[List[V3OutletGeolocation]] = Field(default=None, description="myki ticket outlets")
    status: Optional[V3Status] = None
    __properties: ClassVar[List[str]] = ["outlets", "status"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "outlets": [V3OutletGeolocation.from_dict(_item) for _item in obj["outlets"]] if obj.get("outlets") is not None else None,
