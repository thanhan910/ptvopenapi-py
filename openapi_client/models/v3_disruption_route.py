...
class V3DisruptionRoute(BaseModel):
    ...
    route_number: Optional[StrictStr] = Field(default=None, description="Route number presented to public (i.e. not route_id)")
    ...
    __properties: ClassVar[List[str]] = ["route_type", "route_id", "route_name", "route_number", "route_gtfs_id", "direction"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "direction": V3DisruptionDirection.from_dict(obj["direction"]) if obj.get("direction") is not None else None
        })
        return _obj
