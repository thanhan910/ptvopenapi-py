...
class V3StopAccessibility(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["lighting", "platform_number", "audio_customer_information", "escalator", "hearing_loop", "lift", "stairs", "stop_accessible", "tactile_ground_surface_indicator", "waiting_room", "wheelchair"]
