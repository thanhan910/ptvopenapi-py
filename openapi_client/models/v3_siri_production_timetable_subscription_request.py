...
class V3SiriProductionTimetableSubscriptionRequest(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["start_time", "end_time", "subscriber_ref", "subscription_ref", "siri_format", "siri_version", "consumer_address", "initial_termination_time", "topics"]
