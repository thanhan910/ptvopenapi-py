...
class V3RouteResponse(BaseModel):
    ...
    V3RouteResponse
    """ # noqa: E501
    route: Optional[V3RouteWithStatus] = None
    status: Optional[V3Status] = None
    __properties: ClassVar[List[str]] = ["route", "status"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "route": V3RouteWithStatus.from_dict(obj["route"]) if obj.get("route") is not None else None,
