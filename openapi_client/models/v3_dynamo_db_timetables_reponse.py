...
class V3DynamoDbTimetablesReponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["timetables", "status"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "timetables": [V3DynamoDbTimetable.from_dict(_item) for _item in obj["timetables"]] if obj.get("timetables") is not None else None,
