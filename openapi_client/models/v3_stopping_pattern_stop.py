...
class V3StoppingPatternStop(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["stop_ticket", "stop_distance", "stop_suburb", "stop_name", "stop_id", "route_type", "stop_latitude", "stop_longitude", "stop_landmark", "stop_sequence"]
