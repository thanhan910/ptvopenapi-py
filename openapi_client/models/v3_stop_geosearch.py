...
class V3StopGeosearch(BaseModel):
    ...
    routes: Optional[List[Dict[str, Any]]] = Field(default=None, description="List of routes travelling through the stop")
    ...
    __properties: ClassVar[List[str]] = ["disruption_ids", "stop_distance", "stop_suburb", "stop_name", "stop_id", "route_type", "routes", "stop_latitude", "stop_longitude", "stop_landmark", "stop_sequence"]
