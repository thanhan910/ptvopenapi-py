...
class V3RouteType(BaseModel):
    ...
    V3RouteType
    """ # noqa: E501
    route_type_name: Optional[StrictStr] = Field(default=None, description="Name of transport mode")
    route_type: Optional[StrictInt] = Field(default=None, description="Transport mode identifier")
    __properties: ClassVar[List[str]] = ["route_type_name", "route_type"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "route_type_name": obj.get("route_type_name"),
