...
class V3DisruptionsResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["disruptions", "status"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of disruptions
        if self.disruptions:
            _dict['disruptions'] = self.disruptions.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "disruptions": V3Disruptions.from_dict(obj["disruptions"]) if obj.get("disruptions") is not None else None,
