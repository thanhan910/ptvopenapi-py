...
class V3OutletResponse(BaseModel):
    ...
    V3OutletResponse
    """ # noqa: E501
    outlets: Optional[List[V3Outlet]] = Field(default=None, description="myki ticket outlets")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "outlets": [V3Outlet.from_dict(_item) for _item in obj["outlets"]] if obj.get("outlets") is not None else None,
