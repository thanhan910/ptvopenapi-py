...
class V3SiriDownstreamSubscriptionDeleteRequest(BaseModel):
    ...
    subscription_ref: Optional[List[StrictStr]] = Field(default=None, description="Siri Subscription Reference(s) - Unique to a Subscriber Ref.  If `null`, then all subscriptions will be terminated for the referenced Subscriber.")
    __properties: ClassVar[List[str]] = ["subscriber_ref", "subscription_ref"]
