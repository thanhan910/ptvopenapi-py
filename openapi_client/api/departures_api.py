...
class DeparturesApi:
    ...
    def departures_get_for_stop(
        ...
        platform_numbers: Annotated[Optional[List[StrictInt]], Field(description="Filter by platform number at stop")] = None,
        direction_id: Annotated[Optional[StrictInt], Field(description="Filter by identifier of direction of travel; values returned by Directions API - /v3/directions/route/{route_id}")] = None,
        gtfs: Annotated[Optional[StrictBool], Field(description="Indicates that stop_id parameter will accept \"GTFS stop_id\" data")] = None,
        date_utc: Annotated[Optional[datetime], Field(description="Filter by the date and time of the request (ISO 8601 UTC format) (default = current date and time)")] = None,
        max_results: Annotated[Optional[StrictInt], Field(description="Maximum number of results returned")] = None,
        include_cancelled: Annotated[Optional[StrictBool], Field(description="Indicates if cancelled services (if they exist) are returned (default = false) - metropolitan train only")] = None,
        look_backwards: Annotated[Optional[StrictBool], Field(description="Indicates if filtering runs (and their departures) to those that arrive at destination before date_utc (default = false). Requires max_results &gt; 0.")] = None,
        expand: Annotated[Optional[List[StrictStr]], Field(description="List of objects to be returned in full (i.e. expanded) - options include: All, Stop, Route, Run, Direction, Disruption, VehiclePosition, VehicleDescriptor or None.  Run must be expanded to receive VehiclePosition and VehicleDescriptor information.")] = None,
        include_geopath: Annotated[Optional[StrictBool], Field(description="Indicates if the route geopath should be returned")] = None,
        ...
        _param = self._departures_get_for_stop_serialize(
    ...
    @validate_call
    def departures_get_for_stop_with_http_info(
        self,
        route_type: Annotated[StrictInt, Field(description="Number identifying transport mode; values returned via RouteTypes API")],
        stop_id: Annotated[StrictInt, Field(description="Identifier of stop; values returned by Stops API")],
        platform_numbers: Annotated[Optional[List[StrictInt]], Field(description="Filter by platform number at stop")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[V3DeparturesResponse]:
        """View departures for all routes from a stop
    ...
    @validate_call
    def departures_get_for_stop_without_preload_content(
        self,
        route_type: Annotated[StrictInt, Field(description="Number identifying transport mode; values returned via RouteTypes API")],
        stop_id: Annotated[StrictInt, Field(description="Identifier of stop; values returned by Stops API")],
        platform_numbers: Annotated[Optional[List[StrictInt]], Field(description="Filter by platform number at stop")] = None,
    ...
    def _departures_get_for_stop_serialize(
        self,
        route_type,
        stop_id,
        platform_numbers,
        ...
        if platform_numbers is not None:
            ...
            _query_params.append(('platform_numbers', platform_numbers))
        ...
        if include_cancelled is not None:
            ...
            _query_params.append(('include_cancelled', include_cancelled))
            
        if look_backwards is not None:
            
            _query_params.append(('look_backwards', look_backwards))
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v3/departures/route_type/{route_type}/stop/{stop_id}',
    ...
    @validate_call
    def departures_get_for_stop_and_route(
        self,
        route_type: Annotated[StrictInt, Field(description="Number identifying transport mode; values returned via RouteTypes API")],
        stop_id: Annotated[StrictInt, Field(description="Identifier of stop; values returned by Stops API")],
        route_id: Annotated[StrictStr, Field(description="Identifier of route; values returned by Routes API - v3/routes")],
        direction_id: Annotated[Optional[StrictInt], Field(description="Filter by identifier of direction of travel; values returned by Directions API - /v3/directions/route/{route_id}")] = None,
        gtfs: Annotated[Optional[StrictBool], Field(description="Indicates that stop_id parameter will accept \"GTFS stop_id\" data")] = None,
        date_utc: Annotated[Optional[datetime], Field(description="Filter by the date and time of the request (ISO 8601 UTC format) (default = current date and time)")] = None,
        max_results: Annotated[Optional[StrictInt], Field(description="Maximum number of results returned")] = None,
        ...
        _param = self._departures_get_for_stop_and_route_serialize(
            route_type=route_type,
            stop_id=stop_id,
            route_id=route_id,
            direction_id=direction_id,
    ...
    @validate_call
    def departures_get_for_stop_and_route_with_http_info(
        self,
        route_type: Annotated[StrictInt, Field(description="Number identifying transport mode; values returned via RouteTypes API")],
        stop_id: Annotated[StrictInt, Field(description="Identifier of stop; values returned by Stops API")],
        route_id: Annotated[StrictStr, Field(description="Identifier of route; values returned by Routes API - v3/routes")],
    ...
    @validate_call
    def departures_get_for_stop_and_route_without_preload_content(
        self,
        route_type: Annotated[StrictInt, Field(description="Number identifying transport mode; values returned via RouteTypes API")],
        stop_id: Annotated[StrictInt, Field(description="Identifier of stop; values returned by Stops API")],
        route_id: Annotated[StrictStr, Field(description="Identifier of route; values returned by Routes API - v3/routes")],
    ...
    def _departures_get_for_stop_and_route_serialize(
        self,
        route_type,
        stop_id,
        route_id,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v3/departures/route_type/{route_type}/stop/{stop_id}/route/{route_id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
