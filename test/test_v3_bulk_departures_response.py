...
class TestV3BulkDeparturesResponse(unittest.TestCase):
    """V3BulkDeparturesResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> V3BulkDeparturesResponse:
        """Test V3BulkDeparturesResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V3BulkDeparturesResponse`
        """
        model = V3BulkDeparturesResponse()
        if include_optional:
            return V3BulkDeparturesResponse(
                responses = [
                    openapi_client.models.v3/bulk_departures_update_response.V3.BulkDeparturesUpdateResponse(
                        departures = [
                        ...
                        route_type = 56, 
                        stop_id = 56, 
                        requested_route_direction = openapi_client.models.v3/bulk_departures_route_direction_response.V3.BulkDeparturesRouteDirectionResponse(
                            route_id = '', 
                            direction_id = 56, 
                            direction_name = '', ), 
                        route_direction_status = 0, 
                        route_direction = openapi_client.models.v3/bulk_departures_route_direction_response.V3.BulkDeparturesRouteDirectionResponse(
                            route_id = '', 
                            direction_id = 56, 
                            direction_name = '', ), )
                    ],
                stops = {
                    'key' : openapi_client.models.v3/bulk_departures_stop_response.V3.BulkDeparturesStopResponse(
                        stop_name = '', 
                        stop_id = 56, 
                        stop_latitude = 1.337, 
                ...
                directions = [
                    openapi_client.models.v3/direction.V3.Direction(
                        direction_id = 56, 
                        direction_name = '', 
                        route_id = 56, 
                        route_type = 56, )
    ...
    def testV3BulkDeparturesResponse(self):
        """Test V3BulkDeparturesResponse"""
