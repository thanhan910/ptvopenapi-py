...
class TestV3SiriEstimatedTimetableSubscriptionRequest(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> V3SiriEstimatedTimetableSubscriptionRequest:
        """Test V3SiriEstimatedTimetableSubscriptionRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V3SiriEstimatedTimetableSubscriptionRequest`
        """
        model = V3SiriEstimatedTimetableSubscriptionRequest()
        if include_optional:
