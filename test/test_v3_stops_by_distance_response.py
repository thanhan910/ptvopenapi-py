...
class TestV3StopsByDistanceResponse(unittest.TestCase):
    """V3StopsByDistanceResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> V3StopsByDistanceResponse:
        """Test V3StopsByDistanceResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V3StopsByDistanceResponse`
        """
        model = V3StopsByDistanceResponse()
        if include_optional:
            return V3StopsByDistanceResponse(
                stops = [
                    openapi_client.models.v3/stop_geosearch.V3.StopGeosearch(
                        disruption_ids = [
                            56
                            ], 
                        stop_distance = 1.337, 
    ...
    def testV3StopsByDistanceResponse(self):
        """Test V3StopsByDistanceResponse"""
