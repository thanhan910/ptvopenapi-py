...
class TestV3DisruptionsResponse(unittest.TestCase):
    """V3DisruptionsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> V3DisruptionsResponse:
        """Test V3DisruptionsResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V3DisruptionsResponse`
        """
        model = V3DisruptionsResponse()
        if include_optional:
            return V3DisruptionsResponse(
                disruptions = openapi_client.models.v3/disruptions.V3.Disruptions(
                    general = [
    ...
    def testV3DisruptionsResponse(self):
        """Test V3DisruptionsResponse"""
