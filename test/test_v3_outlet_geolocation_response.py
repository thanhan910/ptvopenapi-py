...
class TestV3OutletGeolocationResponse(unittest.TestCase):
    """V3OutletGeolocationResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> V3OutletGeolocationResponse:
        """Test V3OutletGeolocationResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V3OutletGeolocationResponse`
        """
        model = V3OutletGeolocationResponse()
        if include_optional:
            return V3OutletGeolocationResponse(
                outlets = [
                    openapi_client.models.v3/outlet_geolocation.V3.OutletGeolocation(
    ...
    def testV3OutletGeolocationResponse(self):
        """Test V3OutletGeolocationResponse"""
