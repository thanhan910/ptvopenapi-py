...
class TestV3DisruptionResponse(unittest.TestCase):
    """V3DisruptionResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> V3DisruptionResponse:
        """Test V3DisruptionResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V3DisruptionResponse`
        """
        model = V3DisruptionResponse()
        if include_optional:
            return V3DisruptionResponse(
                disruption = openapi_client.models.v3/disruption.V3.Disruption(
                    disruption_id = 56, 
                    title = '', 
                    url = '', 
                    description = '', 
    ...
    def testV3DisruptionResponse(self):
        """Test V3DisruptionResponse"""
