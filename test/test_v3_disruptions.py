...
class TestV3Disruptions(unittest.TestCase):
    """V3Disruptions unit test stubs"""
    ...
    def make_instance(self, include_optional) -> V3Disruptions:
        """Test V3Disruptions
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V3Disruptions`
        """
        model = V3Disruptions()
        if include_optional:
