...
class TestV3OutletGeolocation(unittest.TestCase):
    """V3OutletGeolocation unit test stubs"""
    ...
    def make_instance(self, include_optional) -> V3OutletGeolocation:
        """Test V3OutletGeolocation
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V3OutletGeolocation`
        """
        model = V3OutletGeolocation()
        if include_optional:
    ...
    def testV3OutletGeolocation(self):
        """Test V3OutletGeolocation"""
